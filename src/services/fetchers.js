...
async function fetchBackendAll() {
  const keys = ['pypi', 'trends', 'gpu', 'github', 'openrouter', 'eia', 'mops', 'github-commits', 'docker', 'hn', 'wikipedia', 'openrouter-ranks', 'dram', 'aws', 'mcp', 'sec', 'huggingface', 'metrics-history'];
