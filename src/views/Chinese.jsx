...
const PRICE_LABELS = ['Claude Opus 4.6','GPT-4o','Gemini 1.5 Pro','Kimi K2.5','GLM-5','DeepSeek V3.2','MiniMax M2.5','MiMo-V2-Pro'];
const PRICE_DATA   = [5.00, 2.50, 1.25, 0.25, 0.30, 0.28, 0.30, 0.30];
const PRICE_COLORS = [C.anthropic, C.openai, C.google, C.kimi, C.zhipu, C.deepseek, C.minimax, C.xiaomi];
...
const priceData = {
  labels: PRICE_LABELS,
  datasets: [{ data: PRICE_DATA, backgroundColor: PRICE_COLORS.map(c => fa(c, 0.75)), borderColor: PRICE_COLORS, borderWidth: 1, borderRadius: 4 }],
};
const benchOpts = {
  ...
  return (
    <div className="cgrid">
      <ChartCard
        ...
        src="openrouter.ai/rankings · China STIB Daily · aicost.org"
      ...
      <ChartCard
        ...
        src="Zhipu AI prospectus · iFlytek filings · IDC China 2024"
      ...
      <ChartCard
        ...
        src="MiniMax HK IPO prospectus (2026) · Sensor Tower"
      ...
      <ChartCard
        ...
        src="Zhipu AI HK IPO prospectus · 1950.ai · Yicai"
      ...
      <ChartCard
        ...
        src="swebench.com · artificial analysis · provider docs"
